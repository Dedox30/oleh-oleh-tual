...
<div class="container">
	<div class="row">
		<div class="col-md-4" >
			<div style="background-color: #1E90FF; padding-bottom: 60px; padding-left: 20px;padding-right: 20px; padding-top: 10px;">
				<h4>PESANAN BARU</h4>
		...
		<div class="col-md-4" >
			<div style="background-color: #DC143C ; padding-bottom: 60px; padding-left: 20px;padding-right: 20px; padding-top: 10px;">
		...
		<div class="col-md-4" >
			<div style="background-color: #32CD32 ; padding-bottom: 60px; padding-left: 20px;padding-right: 20px; padding-top: 10px;">
